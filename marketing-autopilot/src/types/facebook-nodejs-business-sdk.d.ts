 ...
 * here were read from the installed package at build time, not recalled --
 * e.g. Objective keys are lowercase mapping to uppercase values.
 */
declare module 'facebook-nodejs-business-sdk' {
  ...
  export class Campaign {
    ...
    static SpecialAdCategories: Record<string, string>;
  }
  ...
  export class AdSet {
    ...
    static Status: Record<string, string>;
    static DestinationType: Record<string, string>;
  }
  ...
  export class AdCreativeLinkDataCallToAction {
