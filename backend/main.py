...
def upscale_image(input_bytes: bytes, scale: int) -> bytes:
    ...
    Not a generative super-resolution model (see backend/README.md for why:
    the obvious options -- realesrgan's PyPI package, third-party ONNX
    mirrors -- were either broken or unverifiable). This is honest classical
